...
jQuery.sap.declare("sap.secmon.ui.systems.Component");
...
sap.secmon.ui.m.commons.EtdComponent.extend("sap.secmon.ui.systems.Component", {
    ...
    metadata : {
        ...
        includes : [],
        dependencies : {
            libs : [ "sap.ui.layout", "sap.ui.core", "sap.m", "sap.ui.fl", "sap.uxap" ],
            components : []
        },
        handleValidation : true,
        rootView : "sap.secmon.ui.systems.App",
        config : {
            // Will be used by the FLP as title in browser
            title : oTextBundle.getText("SysCtx_Systems"),
        ...
        routing : {
            config : {
                ...
                viewType : "XML",
                viewPath : "sap.secmon.ui.systems",
