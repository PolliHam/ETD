...
var oTextBundle = jQuery.sap.resources({
    url : "/sap/secmon/ui/subnets/i18n/UIText.hdbtextbundle",
    locale : sLocale
});

sap.secmon.ui.m.commons.EtdComponent.extend("sap.secmon.ui.subnets.Component", {
    ...
    metadata : {
        ...
        rootView : "sap.secmon.ui.subnets.App",
        config : {
            // Will be used by the FLP as title in browser
            title : oTextBundle.getText("Subnets_Header"),
            resourceBundle : "/sap/secmon/ui/subnets/i18n/UIText.hdbtextbundle",
            backendConfig : {
                loadCSRFToken : true,
        ...
        routing : {
            config : {
                ...
                viewType : "XML",
                viewPath : "sap.secmon.ui.subnets",
