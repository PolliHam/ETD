...
sap.secmon.ui.m.commons.EtdComponent.extend("sap.secmon.ui.loglearning.prodrules.Component", {
    ...
    metadata : {
        ...
        rootView : "sap.secmon.ui.loglearning.prodrules.App",
        config : {
            // Will be used by the FLP as title in browser
            title : oTextBundle.getText("Interpret_ProdRules"),
        ...
        routing : {
            config : {
                ...
                viewType : "XML",
                viewPath : "sap.secmon.ui.loglearning.prodrules",
            ...
            routes : [ {
                pattern : ":?query:",
                name : "main",
                view : "prodRuntimeRules",
                viewLevel : 0,
                viewType : 'XML',
                targetControl : "idAppControl"
            }, {
                pattern : "Id={Id},Hash={Hash}:?query:",
                name : "prodRuntimeRuleDetail",
                view : "prodRuntimeRuleDetail",
                viewLevel : 1,
                viewType : 'XML',
                targetControl : "idAppControl"
            } ]
