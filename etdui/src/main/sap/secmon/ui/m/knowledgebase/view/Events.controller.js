...
sap.secmon.ui.m.commons.EtdController.extend("sap.secmon.ui.m.knowledgebase.view.Events", {

    /**
     * @memberOf sap.secmon.ui.m.knowledgebase.view.Events
     */
    onInit : function() {
        ...
        sap.secmon.ui.m.commons.FilterBarHelper.initialize.call(this, "table", sap.secmon.ui.m.commons.ServiceConstants.EVENTS_SERVICE, fnNavigation);
    ...
    onRouteMatched : function(oEvent) {
        if (oEvent.getParameter("name") !== "events") {
            return;
        }
        ...
        if (oView.getModel("uiModel").getProperty("/clearSearch")) {
            ...
            oView.byId("table").bindItems("Knowledgebase>/Event", oTemplate, new sap.ui.model.Sorter("lowerDisplayName"));
